...
| `schema`           | JSON     | A JSON schema against which the secret will be validated.                                                                                                                                                             |
...
| `provider_options` | JSON     | The secret's provider options.                                                                                                                                                                                        |
...
| `schema`           | JSON    | Optional parameter, defines how the secret should be validated.                                                                                                                                                                           |
| `provider`         | string  | Optional parameter, defines which provider should be used to get the secret's value.                                                                                                                                                      |
| `provider_options` | JSON    | Optional parameter, defines additional options to get the secret's value via provider.                                                                                                                                                    |
